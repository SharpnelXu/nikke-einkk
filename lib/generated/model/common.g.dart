...
NikkeCharacterData _$NikkeCharacterDataFromJson(Map<String, dynamic> json) =>
    NikkeCharacterData(
      ...
      additionalSkins:
          (json['additional_skins'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      ...
      originalRare:
          $enumDecodeNullable(_$RarityEnumMap, json['original_rare']) ??
          Rarity.unknown,
      ...
      characterClass:
          $enumDecodeNullable(_$NikkeClassEnumMap, json['class']) ??
          NikkeClass.unknown,
      elementId:
          (json['element_id'] as List<dynamic>?)
      ...
      useBurstSkill:
          $enumDecodeNullable(_$BurstStepEnumMap, json['use_burst_skill']) ??
          BurstStep.unknown,
      changeBurstStep:
          $enumDecodeNullable(_$BurstStepEnumMap, json['change_burst_step']) ??
          BurstStep.unknown,
      ...
      corporation:
          $enumDecodeNullable(
            _$CorporationEnumMap,
            json['corporation'],
            unknownValue: Corporation.unknown,
          ) ??
          Corporation.unknown,
...
Map<String, dynamic> _$NikkeCharacterDataToJson(NikkeCharacterData instance) =>
    <String, dynamic>{
      'id': instance.id,
...
WeaponSkillData _$WeaponSkillDataFromJson(
  ...
  weaponType:
      $enumDecodeNullable(_$WeaponTypeEnumMap, json['weapon_type']) ??
      WeaponType.unknown,
  ...
  rateOfFireChangePerShot:
      (json['rate_of_fire_change_pershot'] as num?)?.toInt() ?? 0,
  burstEnergyPerShot: (json['burst_energy_pershot'] as num?)?.toInt() ?? 0,
  targetBurstEnergyPerShot:
      (json['target_burst_energy_pershot'] as num?)?.toInt() ?? 0,
  spotFirstDelay: (json['spot_first_delay'] as num?)?.toInt() ?? 0,
  spotLastDelay: (json['spot_last_delay'] as num?)?.toInt() ?? 0,
  startAccuracyCircleScale:
      (json['start_accuracy_circle_scale'] as num?)?.toInt() ?? 0,
  endAccuracyCircleScale:
      (json['end_accuracy_circle_scale'] as num?)?.toInt() ?? 0,
  accuracyChangePerShot:
      (json['accuracy_change_pershot'] as num?)?.toInt() ?? 0,
  accuracyChangeSpeed: (json['accuracy_change_speed'] as num?)?.toInt() ?? 0,
  autoStartAccuracyCircleScale:
      (json['auto_start_accuracy_circle_scale'] as num?)?.toInt() ?? 0,
  autoEndAccuracyCircleScale:
      (json['auto_end_accuracy_circle_scale'] as num?)?.toInt() ?? 0,
  autoAccuracyChangePerShot:
      (json['auto_accuracy_change_pershot'] as num?)?.toInt() ?? 0,
  autoAccuracyChangeSpeed:
      (json['auto_accuracy_change_speed'] as num?)?.toInt() ?? 0,
  ...
  fullChargeBurstEnergy:
      (json['full_charge_burst_energy'] as num?)?.toInt() ?? 0,
  ...
  useFunctionIdList:
      (json['use_function_id_list'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toList() ??
      const [],
  hurtFunctionIdList:
      (json['hurt_function_id_list'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toList() ??
      const [],
...
Map<String, dynamic> _$WeaponSkillDataToJson(WeaponSkillData instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name_localkey': instance.nameLocalkey,
      'description_localkey': instance.descriptionLocalkey,
...
EquipmentItemData _$EquipmentItemDataFromJson(Map<String, dynamic> json) =>
    EquipmentItemData(
      id: (json['id'] as num?)?.toInt() ?? 0,
      nameLocalkey: json['name_localkey'] as String? ?? '',
      descriptionLocalkey: json['description_localkey'] as String? ?? '',
      ...
      itemType:
          $enumDecodeNullable(_$ItemTypeEnumMap, json['item_type']) ??
          ItemType.equip,
      itemSubType:
          $enumDecodeNullable(_$EquipTypeEnumMap, json['item_sub_type']) ??
          EquipType.unknown,
      characterClass:
          $enumDecodeNullable(_$NikkeClassEnumMap, json['class']) ??
          NikkeClass.unknown,
      itemRarity:
          $enumDecodeNullable(_$EquipRarityEnumMap, json['item_rare']) ??
          EquipRarity.unknown,
      gradeCoreId: (json['grade_core_id'] as num?)?.toInt() ?? 0,
      growGrade: (json['grow_grade'] as num?)?.toInt() ?? 0,
      stat:
          (json['stat'] as List<dynamic>?)
              ?.map((e) => EquipmentStat.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
      optionSlots:
          (json['option_slot'] as List<dynamic>?)
              ?.map((e) => OptionSlot.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
...
Map<String, dynamic> _$EquipmentItemDataToJson(EquipmentItemData instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name_localkey': instance.nameLocalkey,
      'description_localkey': instance.descriptionLocalkey,
...
EquipmentStat _$EquipmentStatFromJson(Map<String, dynamic> json) =>
    EquipmentStat(
      statType:
          $enumDecodeNullable(_$StatTypeEnumMap, json['statType']) ??
          StatType.none,
      statValue: (json['statValue'] as num?)?.toInt() ?? 0,
    );

Map<String, dynamic> _$EquipmentStatToJson(EquipmentStat instance) =>
    <String, dynamic>{
...
OptionSlot _$OptionSlotFromJson(Map<String, dynamic> json) => OptionSlot(
  ...
  optionSlotSuccessRatio:
      (json['optionSlotSuccessRatio'] as num?)?.toInt() ?? 0,
);

Map<String, dynamic> _$OptionSlotToJson(OptionSlot instance) =>
    <String, dynamic>{
